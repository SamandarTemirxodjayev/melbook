import { m as mergeConfig, j as input, b as appConfig, k as inputMenu, d as __nuxt_component_2$1, e as __nuxt_component_1, f as useUI, g as defu, h as useInjectButtonGroup, t as twMerge, i as twJoin, n as useToast, l as get, o as navigateTo, p as __nuxt_component_2, _ as _export_sfc } from './server.mjs';
import { o as o$2, u as u$3, c, f as f$1, w, t, i, E, A as A$1, T, I as I$1, s as s$1, a as i$3, N as N$1, l, b as i$1, d as u$1, e as usePopper, g as l$1, h as dateFormat, O as O$1, j as o$1, n as n$1, _ as __nuxt_component_0, k as __nuxt_component_1$1 } from './formatters-BQavADfa.mjs';
import { f as f$2, s as s$2, d as defineShortcuts, o as o$3, t as t$2, _ as __nuxt_component_3, a as __nuxt_component_4 } from './defineShortcuts-GScxOI4F.mjs';
import { _ as __nuxt_component_0$1, a as __nuxt_component_1$2, b as __nuxt_component_2$2 } from './Input-Cio2Y64Y.mjs';
...
let ie = Symbol("VirtualContext"), ke = defineComponent({ name: "VirtualProvider", setup(a, { slots: T2 }) {
  ...
  function D(l2 = (i2) => i2) {
    let i2 = d$1.value !== null ? b.value[d$1.value] : null, f2 = l2(b.value.slice()), p = f2.length > 0 && f2[0].dataRef.order.value !== null ? f2.sort((C, F) => C.dataRef.order.value - F.dataRef.order.value) : O$1(f2, (C) => o$2(C.dataRef.domRef)), O$1$1 = i2 ? p.indexOf(i2) : null;
  ...
  let t$12 = { comboboxState: o2, value: k, mode: L, compare(l2, i2) {
    ...
    P.value = false, n2 !== null && cancelAnimationFrame(n2), n2 = requestAnimationFrame(() => {
      ...
      let O2 = l2 === c.Specific ? i2 : f$1({ focus: l2 }, { resolveItems: () => p.options, resolveActiveIndex: () => p.activeOptionIndex, resolveId: (C) => C.id, resolveDisabled: (C) => C.dataRef.disabled });
    ...
    d$1.value === null && t$12.isSelected(i2.value.value) && (p.activeOptionIndex = p.options.indexOf(f2)), b.value = p.options, d$1.value = p.activeOptionIndex, V.value = 2, p.options.some((O2) => !o$2(O2.dataRef.domRef)) && (y = requestAnimationFrame(() => {
      let O2 = D();
    ...
    return u$3(L.value, { [0]: () => t$12.compare(toRaw(t$12.value.value), toRaw(l2)), [1]: () => toRaw(t$12.value.value).some((i2) => t$12.compare(toRaw(i2), toRaw(l2))) });
  }, isActive(l2) {
    return d$1.value === t$12.calculateIndex(l2);
  } };
  w([e$1, v, s$12], () => t$12.closeCombobox(), computed(() => o2.value === 0)), provide(ne, t$12), t(computed(() => u$3(o2.value, { [0]: i.Open, [1]: i.Closed })));
  let I2 = computed(() => {
    var l2;
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...l2 != null && k.value != null ? e({ [l2]: k.value }).map(([U, ue]) => h(f$2, E({ features: s$2.Hidden, key: U, as: "input", type: "hidden", hidden: true, readOnly: true, form: f2, name: U, value: ue }))) : [], A$1({ theirProps: { ...r, ...T(p, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: O2, slots: T$1, attrs: r, name: "Combobox" })]);
  };
} });
...
let tt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: T2, slots: r, expose: R }) {
  ...
  return i$1({ container: computed(() => o$2(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(s2) {
    ...
    var d2, V, P;
    let s2 = { open: o2.comboboxState.value === 0 }, h$1 = { "aria-labelledby": (P = (d2 = o$2(o2.labelRef)) == null ? void 0 : d2.id) != null ? P : (V = o$2(o2.buttonRef)) == null ? void 0 : V.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0 }, b = T(a, ["hold"]);
    return A$1({ ourProps: h$1, theirProps: b, slot: s2, attrs: T$1, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r, default: () => [h(ke, {}, r.default)] } : r, features: N$1.RenderStrategy | N$1.Static, visible: v.value, name: "ComboboxOptions" });
  };
...
//# sourceMappingURL=index-Bf_vm7Oh.mjs.map
