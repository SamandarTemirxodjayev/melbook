import { h as dateFormat, _ as __nuxt_component_0, k as __nuxt_component_1 } from './formatters-BQavADfa.mjs';
import { m as mergeConfig, b as appConfig, z as button, p as __nuxt_component_2, f as useUI, n as useToast, o as navigateTo, _ as _export_sfc } from './server.mjs';
import { defineComponent, toRef, computed, useSSRContext, ref, unref, withCtx, createVNode, createTextVNode, toDisplayString, isRef, mergeProps } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="text-2xl font-bold">Foydalanuvchilar</div>`);
...
//# sourceMappingURL=index-B8p9r3hi.mjs.map
